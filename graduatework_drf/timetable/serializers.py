...
from .models import *
from student_performance.serializers import LecturerInformationSerializer, UsernameSerializer, LessonScoresSerializer
...
class LessonSerializer(serializers.ModelSerializer):
    ...
    student_scores = LessonScoresSerializer(many=True)
    class Meta:
        model = Lesson
