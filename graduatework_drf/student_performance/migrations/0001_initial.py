# Generated by Django 5.0.1 on 2024-01-09 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='student_performance.group', verbose_name='Группа')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('groups', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, to='student_performance.group', verbose_name='группы')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='пользователь')),
                ('subjects', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, to='student_performance.subject', verbose_name='предметы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecturer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='student_performance.lecturer', verbose_name='Преподаватель')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_performance.group', verbose_name='Группа')),
                ('lecturer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='student_performance.lecturer', verbose_name='Преподаватель')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_performance.subject', verbose_name='Дисциплина')),
            ],
            options={
